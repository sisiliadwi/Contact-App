        ...
        <form class="form-group">
            <div class="mb-3 bg p-5 rounded"> 
                ...
                <label for="nohp" class="form-label mt-4 fw-semibold">No. HP</label>
                    <input type="text" class="form-control custom-input" id="nohp" placeholder="Masukkan no. hp"value="<?= $db_contact[0]['no_hp'] ?>"/>
                <label for="nama" class="form-label mt-4 fw-semibold ">Nama</label>
                    <input type="text" class="form-control custom-input" id="nama" placeholder="Masukkan nama"value="<?= $db_contact[0]['nama_pemilik'] ?>"/>
                <label for="jenis" class="form-label mt-4 fw-semibold ">Jenis Kelamin</label>
                    <input type="text" class="form-control custom-input" id="jenis" placeholder="Masukkan Jenis Kelamin"value="<?= $db_contact[0]['jenis_kelamin'] ?>"/>
